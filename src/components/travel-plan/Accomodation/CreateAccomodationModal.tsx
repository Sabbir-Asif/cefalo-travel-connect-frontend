...
import { addLodgeToTravelPlanAPI } from "../../../utils/api/travel-plan";
...
const CreateAccomodationModal: React.FC<Props> = ({ travelPlanId, onClose, onAdd }) => {
    ...
    const handleAddLodge = async () => {
        ...
        const data: TourLodge = {
            travelplan_id: travelPlanId,
            lodge_id: selectedLodge.id,
        };

        await addLodgeToTravelPlanAPI(data);

...
import { deleteBlogLodgeAPI } from '../../../utils/api/blog';
...
const AccomodationCard: React.FC<AccomodationCardProps> = ({ accomodation, blogId, onDelete }) => {
    ...
    const handleDelete = async () => {
        setIsDeleting(true);
        try {
            const status = await deleteBlogLodgeAPI(blogId, accomodation.id);
            if (status === 204) {
